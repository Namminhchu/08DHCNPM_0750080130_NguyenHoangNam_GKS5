...
class _MarketPlacePageState extends State<MarketPlacePage> with ProjectPadding{
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (String? text) {
                                setState(() {
                                  searchingText = searchController.text.toLowerCase();
                                });
                              },
                            ),
                          ),
  ...
  Widget buildSearch(BuildContext context, String? searchingText) {
    late final List<CollectionModel> newItems = [];
      ...
      return Expanded(
        child: ListView.builder(
          ...
          itemBuilder: (context, index){
            return ItemModel(model: newItems[index]);
          },
        ),
      );
    }else{
...
class _CategoryModel extends StatelessWidget with ProjectPadding{
  _CategoryModel({required CategoryModel model,
  }) : _model = model;
